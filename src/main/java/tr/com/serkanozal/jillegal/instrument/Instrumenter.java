...
public interface Instrumenter<T> {
    ...
    Instrumenter<T> addConstructor(String code, Class<?> [] parameters) throws Exception; 
    Instrumenter<T> updateConstructor(String code, Class<?> [] parameters) throws Exception;
    Instrumenter<T> deleteConstructor(Class<?> [] parameters) throws Exception;
    ...
    Instrumenter<T> addMethod(String methodName, Class<?> returnType, String code, Class<?> [] parameters) throws Exception;
    Instrumenter<T> updateMethod(String methodName, String code, Class<?> [] parameters) throws Exception;
    Instrumenter<T> deleteMethod( String methodName, Class<?> [] parameters) throws Exception;
