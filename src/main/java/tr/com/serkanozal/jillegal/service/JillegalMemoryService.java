...
public class JillegalMemoryService {
	...
	private final static Logger logger = Logger.getLogger(JillegalMemoryService.class);
    ...
    private static int addressShiftSize;
    ...
    private JillegalMemoryService() {
        throw new UnsupportedOperationException("Can't create instance of " + "<" + getClass( ).getName( ) + ">");
    }
